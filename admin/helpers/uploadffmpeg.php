...
class uploadFfmpegHelper
{
	...
	function uploadFfmpeg($arrFormData,$idval)
	{
		...
		if ($hdfile == "h264") {
			...
			exec($strFfmpegPath . ' ' . "-i" . ' ' . $target_path1 . ' ' . "-r 1 -s 120x68 -f image2" . ' ' . $vpath . $idval . '_thumb' . ".jpeg");
			exec($strFfmpegPath . ' ' . "-i" . ' ' . $target_path1 . ' ' . "-r 1 -s" . ' ' . $previewwidth . "x" . $previewheight . ' ' . " -f image2" . ' ' . $vpath . $idval . '_preview' . ".jpeg");
