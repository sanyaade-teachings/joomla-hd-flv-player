...
?>
<script type="text/javascript" src="<?php echo $thumbpath . '/upload_script.js'; ?>"></script>

<script language="JavaScript" type="text/javascript">
	var COM_HDFLVPLAYER_JERR_ADNAME = '<?php echo JText::_("COM_HDFLVPLAYER_JERR_ADNAME"); ?>'
	var COM_HDFLVPLAYER_JERR_UPLOAD_FILE = '<?php echo JText::_("COM_HDFLVPLAYER_JERR_UPLOAD_FILE"); ?>'
	var COM_HDFLVPLAYER_JERR_VIDEO_URL = '<?php echo JText::_("COM_HDFLVPLAYER_JERR_VIDEO_URL"); ?>'
    Joomla.submitbutton = function(pressbutton) {
        ...
        if (pressbutton == "saveads" || pressbutton=="applyads")
        {
            ...
            {
                alert(COM_HDFLVPLAYER_JERR_ADNAME);
                return;
            }
            ...
            if ((document.getElementById('typeofadd').value=="prepost"))
            {
                ...
                if((bol_file1==true) && (bol_fileselect==true))
                {
                    ...
                    {
                        alert(COM_HDFLVPLAYER_JERR_UPLOAD_FILE);
                        return;
                ...
                if(bol_file1==false)
                {
                    ...
                    {
                        alert(COM_HDFLVPLAYER_JERR_VIDEO_URL);
                        return;
                    }
                    if(document.getElementById('posturl').value!="")
                    {
...
<div class="width-60 fltlft">
    <fieldset class="adminform">
        <legend><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_ADD_SETTINGS');?></legend>
        <table class="adminlist">
            <thead>
                <tr>
                    <th>
        					<?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_SETTINGS');?>
                    </th>
                    <th>
        					<?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_VALUE');?>
                    </th>
                </tr>
            </thead>
            <tfoot>
            ...
            <tbody>
                ...
                <tr><td class="key" width="200px;"><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_SELECT_SETTINGS');?></td>
                    <td>
...
?> /><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_PREPSOT_AD');?>
...
?>/><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_MIDROLL_AD');?>
                    </td>
                </tr>
            </tbody>
        </table>
...
?>
                               <div class="width-60 fltlft">
                                   ...
                                   <fieldset class="adminform" id="videodet" <?php echo $var1; ?>>
                                       <legend><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_VIDEO_DETAILS');?></legend>
                                       <table class="adminlist">
                                           <thead>
                                               <tr>
                                                   <th>
                                           ...
                                           <tbody>
                                               <tr><td class="key" width="200px;"><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_FILEPATH');?></td>
                                                   <td>
...
?> value="File" onclick="fileads('File');"  /><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_FILE');?>
                        <input type="radio" style="float:none;" name="filepath" id="filepath02"<?php
                               if ($rs_roll['rs_ads']->filepath == "Url") {
                                   echo 'checked="checked" ';
                               }
?>value="Url" onclick="fileads('Url');"/><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_URL');?>
                    </td>
                </tr>

                <tr id="postrollnf" name="postrollnf"><td class="key"><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_UPLOAD_PREPOST_VIDEO');?></td>
                    <td>
                        ...
                        <div id="f1-upload-progress" style="display:none">
                            ...
                            <span id="f1-upload-message" style="float:right;font-size:12px;background:#FFAFAE;padding:5px 150px 5px 10px;">
                                <b><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_UPLOAD_FAILED');?></b> <?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_UPLOAD_CANCELLED');?>
                            </span>
                ...
                <tr id="postrollurl">
                    <td class="key">
                        <?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_PREPOST_URL');?>
                    </td>
                    <td>
    ...
    <div class="width-60 fltlft">
        ...
        <fieldset class="adminform">
            ...
            <table class="adminlist">
                ...
                <tbody>
                    <tr><td class="key"><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_ADNAME');?></td><td><input type="text" name="adsname"  id="adsname" style="width:300px" maxlength="250" value="<?php echo $rs_roll['rs_ads']->adsname; ?>" /></td></tr>
                       <tr><td class="key"><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_AD_DESCRIPTION');?></td>
                           <td>
                               <textarea rows="4" cols="40" style="width:auto;" name="adsdesc" id="adsdesc"><?php echo trim($rs_roll['rs_ads']->adsdesc); ?></textarea>
                           </td> </tr>
                       <tr><td class="key"><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_TARGET_URL');?></td><td><input type="text" name="targeturl"  id="targeturl" style="width:300px" maxlength="250" value="<?php echo $rs_roll['rs_ads']->targeturl; ?>" /></td></tr>
                       <tr><td class="key"><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_ADVISIT_URL');?></td><td><input type="text" name="clickurl"  id="clickurl" style="width:300px" maxlength="250" value="<?php echo $rs_roll['rs_ads']->clickurl; ?>" /></td></tr>
                       <tr><td class="key"><?php echo JText::_('COM_HDFLVPLAYER_VIEW_ADS_TMPL_IMPRESSION_URL');?></td><td><input type="text" name="impressionurl"  id="impressionurl" style="width:300px" maxlength="250" value="<?php echo $rs_roll['rs_ads']->impressionurl; ?>" /></td></tr>
                       <tr><td class="key"><?php echo JText::_('COM_HDFLVPLAYER_PUBLISHED');?></td>
                           <td>
                               <input type="radio" name="published"  value=1  checked="checked" /><?php echo JText::_('COM_HDFLVPLAYER_YES');?>
                               <input type="radio" style="float:none;" name="published" value=0 /><?php echo JText::_('COM_HDFLVPLAYER_NO');?></td>
                       </tr>
                   </tbody>
               </table>
           </fieldset>
