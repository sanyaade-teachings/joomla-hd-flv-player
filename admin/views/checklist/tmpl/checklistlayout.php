...
<form action="index.php?option=com_hdflvplayer&task=checklist" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
	...
	<table class="adminlist">
		...
		<thead>
			<tr>
				<th width="1%">#</th>
				<th width="5%">Name of the file/folder</th>
				<th width="8%">To be checked</th>
	...
	<span class="hd_alert">
		<table class="">
			<tr>
				<td><strong>Note :</strong> Most of the hosting company limit the
					...
					:http://www.yourdomain.com/videos/videoname.mp4</td>
			</tr>
		</table> 
	</span>
