			...
			<table class="adminlist">
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="radio" style="float: none;" name="showoption" value="0" checked>Always Show 
						<input type="radio" name="showoption" style="float: none;" value=1 <?php if($rs_edit->showoption == '1') echo 'checked'; ?> /> 
						Close After:<input type="text" style="float: none;" name="closeadd" value=<?php echo $rs_edit->closeadd; ?>>&nbsp;Sec</td>
					</tr>
