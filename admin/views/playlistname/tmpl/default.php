    ...
    <table class="adminlist">
        ...
        <thead>
            <tr>
                ...
                <th width="5%"><?php echo JHTML::_('grid.sort', 'ID', 'id', @$rs_showplaylistname['lists']['order_Dir'], @$rs_showplaylistname['lists']['order'],'playlistname'); ?></th>
            </tr>
        </thead>
        ...
        ?>
                <tr class="row">
            		...
            		<td> 
            			<a href="<?php if ($resplaylist->id) { echo $link; }?>"><?php echo $resplaylist->name; ?> </a> 
            		</td>
                    <td align="center"> <?php echo $published; ?> </td>
                    <td align="center"><?php echo $resplaylist->id; ?></td>
                </tr>
        <?php
            }
        }
