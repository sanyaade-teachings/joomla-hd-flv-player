...
<div class="contus-contropanel">
    <h2 class="heading">HDFLV Player Control panel</h2>
    </div>
...
echo $pane->startPanel( 'Welcome to HD Flv Player', 'panel1' );?>
    ...
    <div class="main-text">
        ...
        <div class="text">
  Joomla HD Flv Player enhances the quality of your joomla sites or blogs. Some of the most salient features like Lighttpd, RTMP streaming, Monetization, Native language support, Bookmarking etc makes the Player Unique!! HTML5 support in the Player facilitates the purpose of playing it in IPhones and IPads.
